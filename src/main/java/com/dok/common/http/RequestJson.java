...
public class RequestJson implements Request {
  ...
  private RequestJson(String url, Method method, boolean ping, Connector urlc, List<NameValuePair> params) {
    this.url = url;
    //this.method = method;
    this.ping = ping;
    this.urlc = urlc;
...
//  }
  ...
  public static RequestJson.Builder configure() {
  ...
  public static class Builder {
    ...
    public RequestJson build() {
      ...
      return new RequestJson(url, method, ping, urlc, params);
    }
