...
public class ResourceUtil {
    ...
    public static URL getResource(String resource) {
        ...
        for (ClassLoader cl : CLASSLOADER) {
            System.out.printf("Index%d : %s%n", idx++, (cl == null ? "NULL" : cl.getClass().getName()));
            if(cl != null) {
    ...
    public static String getRuntimeHomeDirectory(Class<?> clazz) {
        String homeDirectory = clazz.getProtectionDomain().getCodeSource().getLocation().getPath();
